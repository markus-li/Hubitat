...
metadata {
    definition (name: "Tasmota - Universal Switch as Presence Sensor (Child)", namespace: "tasmota", author: "Markus Liljergren", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-switch-as-presence-sensor-child-expanded.groovy") {
        capability "Sensor"
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal Switch as Presence Sensor (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-switch-as-presence-sensor-child-expanded.groovy']
