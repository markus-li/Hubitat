...
metadata {
    definition (name: "Tasmota - Universal Switch as Garage Door (Child)", namespace: "tasmota", author: "Markus Liljergren", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-universal-switch-as-garage-door-child-expanded.groovy") {
        capability "Sensor"
        capability "Actuator"
        capability "Switch"
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal Switch as Garage Door (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-universal-switch-as-garage-door-child-expanded.groovy']
