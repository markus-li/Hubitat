...
metadata {
    definition (name: "Tasmota - Universal Switch as Water Sensor (Child)", namespace: "tasmota", author: "Markus Liljergren", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-universal-switch-as-water-sensor-child-expanded.groovy") {
        capability "Sensor"
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal Switch as Water Sensor (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-universal-switch-as-water-sensor-child-expanded.groovy']
