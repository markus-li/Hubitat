...
metadata {
    ...
    definition (name: "Tasmota - Universal Plug/Outlet (Child)", namespace: "tasmota", author: "Markus Liljergren", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-universal-plug-outlet-child-expanded.groovy") {
        capability "Actuator"
        capability "Switch"
        capability "Outlet"
        capability "Refresh"
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal Plug/Outlet (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-universal-plug-outlet-child-expanded.groovy']
