...
metadata {
	definition (name: "Zigbee - Xiaomi/Aqara Contact Sensor", namespace: "markusl", author: "Markus Liljergren", vid: "generic-shade", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-xiaomi-aqara-contact-sensor-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Zigbee - Xiaomi/Aqara Contact Sensor', 'namespace': 'markusl', 'author': 'Markus Liljergren', 'vid': 'generic-shade', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-xiaomi-aqara-contact-sensor-expanded.groovy']
...
ArrayList<String> parse(String description) {
    ...
    if(msgMap["clusterId"] == "0013") {
        ...
        if(msgMap["value"].containsKey("openClose")) {
            sendOpenCloseEvent(msgMap["value"]["openClose"])
        }
...
void sendOpenCloseEvent(boolean openClose) {
    if(invertContact == null) invertContact = false
    logging("sendOpenCloseEvent(openClose=$openClose) invertContact=$invertContact", 1)
